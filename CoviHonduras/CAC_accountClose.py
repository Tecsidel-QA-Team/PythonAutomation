...
class CAC_accountClose(unittest.TestCase):
    ...
    def test(self):        
        ...
        if self.accountClosed==True:
            ...
            unittest.TestCase.fail("No se puede cerrar la cuenta "+self.accountNumbr[7:16]+" porque ya está cerrada")
        ...
        if self.NumbVeh==True:
            ...
            unittest.TestCase.fail("No se puede cerrar la cuenta "+self.accountNumbr[7:16]+" porque tiene "+self.NumbVeh+" veh�culo/s asignado/s")
        time.sleep(1)
