...
class CAC_LiquidacionParcial(unittest.TestCase):   
    ...
    def test(self):   
        ...
        CAC_LiquidacionParcial.accountLiquidacionParcial(self)
        time.sleep(1)
    ...
    def accountLiquidacionParcial(self):
        ...
        time.sleep(.5)
        driver.find_element_by_id("ctl00_ContentZone_NumberCH02201").send_keys(str(settings.ranNumbr(1,5)))
        ActionChains(driver).click(driver.find_element_by_id("ctl00_ContentZone_NumberCH02202_txt_formated")).perform()
        ...
        ActionChains(driver).send_keys(str(settings.ranNumbr(10000,99999))).perform()
        time.sleep(.5)
        driver.find_element_by_id("ctl00_ContentZone_NumberBD201").send_keys(str(settings.ranNumbr(1,5)))
        ActionChains(driver).click(driver.find_element_by_id("ctl00_ContentZone_NumberBD202_txt_formated")).perform()
        ActionChains(driver).send_keys(str(settings.ranNumbr(10000,99999))).perform()
        time.sleep(1)
