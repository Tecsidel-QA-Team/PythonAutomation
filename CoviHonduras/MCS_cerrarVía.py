...
class MCS_cerrarVia(unittest.TestCase):    
    ...
    def test(self):   
        ...
        try:
            ...
            time.sleep(.600)
            driver.find_element_by_link_text("Cerrar la vía").click()
            time.sleep(.600)
            if self.isAlertPresent()==True:
                driver.switch_to_alert().accept()
        
            driver.find_element_by_id("sipt_fieldform_fieldpart_pwduser").send_keys("00001")
            driver.find_element_by_id("sipt_fieldform_fieldpart_pwdpassword").send_keys("00001")
            time.sleep(1)
            settings.elementClick("btn_sipt_fieldform_okpart_pwd")
            ...
            driver.get_screenshot_as_file("E:\\Selenium\\cerrarViaResults"+timet+".jpeg")
            driver.get_screenshot_as_file("E:\\workspace\\Maria_Repository\\MCS_application\\attachments\\cerrarViaResults.jpeg")
