...
class MCS_reiniciarVia(unittest.TestCase):    
    ...
    def test(self):   
        ...
        try:
            ...
            mcsVer = driver.find_element_by_id(mcsVersion).time
            ...
            time.sleep(.6)
            driver.find_element_by_link_text("Reiniciar la vía").click()
            time.sleep(.6)
            ...
            driver.get_screenshot_as_file("E:\\Selenium\\reiniciarViaResults"+timet+".jpeg")
            driver.get_screenshot_as_file("E:\\workspace\\Maria_Repository\\MCS_application\\attachments\\reiniciarViaResults.jpeg")
